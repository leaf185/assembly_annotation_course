.libPaths("/data/users/lfrei/R/library")
if (!requireNamespace('tidyverse', quietly = TRUE)) {
    install.packages('tidyverse', repos = "https://cloud.r-project.org/", lib = "/data/users/lfrei/R/library")
  }
if (!requireNamespace('data.table', quietly = TRUE)) {
    install.packages('data.table', repos = "https://cloud.r-project.org/", lib = "/data/users/lfrei/R/library")
  }
if (!requireNamespace('cowplot', quietly = TRUE)) {
    install.packages('cowplot', repos = "https://cloud.r-project.org/", lib = "/data/users/lfrei/R/library")
  }
if (!requireNamespace('UpSetR', quietly = TRUE)) {
    install.packages('UpSetR', repos = "https://cloud.r-project.org/", lib = "/data/users/lfrei/R/library")
  }
if (!requireNamespace('ComplexUpset', quietly = TRUE)) {
    install.packages('ComplexUpset', repos = "https://cloud.r-project.org/", lib = "/data/users/lfrei/R/library")
  }
...
dat <- fread("/data/users/lfrei/assembly_annotation_course/annotation_evaluation/genespace/orthofinder/Results_Nov13/Comparative_Genomics_Statistics/Statistics_PerSpecies.tsv", header = T, fill = TRUE)
...
orthogroups <- fread("/data/users/lfrei/assembly_annotation_course/annotation_evaluation/genespace/orthofinder/Results_Nov13/Orthogroups/Orthogroups.GeneCount.tsv")
